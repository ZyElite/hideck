...
<style scoped>
.balance-panel { min-height: 0; display: flex; flex-direction: column; border-left: 1px solid var(--ui-border); }
...
@media (max-width: 1023px) { .balance-panel { border-left: 0; border-top: 1px solid var(--ui-border); max-height: 360px; } }
</style>
