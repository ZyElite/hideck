...
DIST_DIR ?= dist
MAIN_PACKAGE ?= ./cmd/hideck

LDFLAGS = -s -w -X 'github.com/yibaiba/hideck/internal/global.Version=$(VERSION)' -X 'github.com/yibaiba/hideck/internal/global.BuildTime=$(BUILD_TIME)'
